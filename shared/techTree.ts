...
export const TECH_TREE: TechNode[] = [
  ...
  },
  {
    ...
    researchWeeks: 130,
    cost: 200,
    prerequisites: ['stealth_tech'],
    unlocksEra: ['1990s', '2010s', 'modern'],
  },
  {
    id: 'chemical_weapons',
    name: 'Chemical & Biological Programme',
    category: 'military',
  ...
  },
  {
    ...
    researchWeeks: 260,
    cost: 500,
    prerequisites: ['ai_research', 'biotech'],
    unlocksEra: ['2010s', 'modern'],
  },
  {
    id: 'asteroid_mining',
    name: 'Asteroid Mining Programme',
    category: 'science',
  ...
  },
  {
    ...
    researchWeeks: 520,
    cost: 800,
    prerequisites: ['nuclear_fission', 'renewable_energy'],
    unlocksEra: ['modern'],
  },
  {
    id: 'quantum_internet',
  ...
  },
  {
    ...
    researchWeeks: 416,
    cost: 700,
    prerequisites: ['neural_interfaces', 'quantum_computing'],
    unlocksEra: ['modern'],
  },

  // ══════════════════════════════════════════════════════════════════════════
  // ECONOMY — EXPANSION PACK
  // ══════════════════════════════════════════════════════════════════════════
  {
  ...
  {
    id: 'green_economy',
    name: 'Green Economic Transition',
    category: 'economy',
  ...
  },
  {
    ...
    name: 'International Legal Framework',
    category: 'government',
  ...
  {
    id: 'cyber_defence_agency',
    name: 'National Cyber Defence Agency',
    category: 'government',
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    researchWeeks: 208,
    cost: 400,
    prerequisites: ['universal_healthcare', 'central_banking'],
    unlocksEra: ['2010s', 'modern'],
  },
  {
    id: 'cultural_exports',
    name: 'Cultural Export Programme',
    category: 'society',
  ...
  },
  {
    ...
    name: 'Immigration & Integration Policy',
    category: 'society',
  ...
  // ══════════════════════════════════════════════════════════════════════════
  // INFRASTRUCTURE — EXPANSION PACK
  // ══════════════════════════════════════════════════════════════════════════
  {
    id: 'desalination',
    name: 'Industrial Desalination Plants',
    category: 'infrastructure',
  ...
  },
  {
    ...
    researchWeeks: 520,
    cost: 800,
    prerequisites: ['advanced_manufacturing', 'space_launch'],
    unlocksEra: ['modern'],
  },
  {
    id: 'hyperloop',
    name: 'Hyperloop Network',
    category: 'infrastructure',
    description: 'Vacuum-tube transport at near-supersonic speed between major cities.',
    researchWeeks: 312,
    cost: 500,
    prerequisites: ['high_speed_rail_tech', 'advanced_manufacturing'],
    unlocksEra: ['modern'],
  },
  {
    id: 'vertical_farming',
    ...
    researchWeeks: 156,
    cost: 250,
    prerequisites: ['renewable_energy', 'biotech'],
    unlocksEra: ['2010s', 'modern'],
  },
]
