...
const CITY_CENTRES: Record<string, [number, number, number]> = {
  ...
  raqqa: [39.0, 35.9, 10],
  idlib: [36.6, 35.9, 10],
  'deir ez-zor': [40.1, 35.3, 10],
  latakia: [35.8, 35.5, 10],
  gaza: [34.5, 31.5, 10],
  rafah: [34.25, 31.28, 11],
  'khan younis': [34.3, 31.35, 11],
  'deir al-balah': [34.35, 31.42, 11],
  jabaliya: [34.48, 31.53, 11],
  'beit hanoun': [34.54, 31.55, 11],
  ramallah: [35.2, 31.9, 11],
  hebron: [35.1, 31.5, 11],
  nablus: [35.3, 32.2, 11],
  bethlehem: [35.2, 31.7, 11],
  jenin: [35.3, 32.5, 11],
  jericho: [35.4, 31.9, 11],
  beirut: [35.5, 33.9, 10],
  sidon: [35.4, 33.6, 10],
  tyre: [35.2, 33.3, 10],
  'tripoli lebanon': [35.8, 34.4, 10],
  jerusalem: [35.2, 31.8, 10],
  'tel aviv': [34.8, 32.1, 9],
  haifa: [35.0, 32.8, 10],
  ashkelon: [34.57, 31.67, 10],
  ashdod: [34.65, 31.8, 10],
  eilat: [34.95, 29.55, 10],
  nazareth: [35.3, 32.7, 10],
  basra: [47.8, 30.5, 10],
  najaf: [44.3, 32.0, 10],
  karbala: [44.0, 32.6, 10],
  fallujah: [43.8, 33.35, 10],
  kirkuk: [44.4, 35.5, 10],
  erbil: [44.0, 36.2, 10],
  sulaymaniyah: [45.4, 35.6, 10],
  qom: [50.9, 34.6, 10],
  'mazar-i-sharif': [67.1, 36.7, 10],
  dubai: [55.3, 25.2, 9],
